    ...
    <div className="space-y-16 pb-20">
      ...
      <AnimatedSection>
        <section className="relative w-full max-w-7xl mx-auto px-3 sm:px-6 pt-4 sm:pt-8">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#faf2ee] via-[#f8ece8] to-[#f4dcd3] p-6 sm:p-10 text-center border border-[#ebd3cb]/80 shadow-lg space-y-3.5">
            ...
            <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
              <Link
                href="/productos"
                className="px-6 py-2.5 sm:px-8 sm:py-3.5 rounded-full bg-[#785b4f] hover:bg-[#5c4a42] text-white font-julius font-bold text-[10px] sm:text-xs uppercase tracking-widest shadow-md transition transform hover:scale-105 border border-[#5c4a42]"
              >
                EXPLORAR COLECCIÓN
              </Link>
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-2.5 sm:px-8 sm:py-3.5 rounded-full bg-white hover:bg-[#f8ece8] text-[#8c6b5d] font-julius font-bold text-[10px] sm:text-xs uppercase tracking-widest shadow-md transition transform hover:scale-105 border border-[#ebd3cb]"
              >
